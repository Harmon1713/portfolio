const translations = {
  en: {
      ...
      frontendContent: "This portfolio website is the example of my skillset with HTML, CSS, and JavaScript; below are the skills I've used to create an interactive and dynamic user interface.",
      javascriptSkills: "Javascript skills",
      asyncProgramming: "Asynchronous Programming: The fetch API is used to asynchronously retrieve JSON data, demonstrating handling of promises with .then() and .catch() for error handling.",
      domManipulation: "DOM Manipulation: Manipulating the Document Object Model (DOM) to dynamically change content, styles, and classes based on user actions or data, such as updating text content, showing and hiding elements, and adding or removing CSS classes.",
      eventHandling: "Event Handling: Setting up event listeners to handle user interactions like clicks, scrolling, and key presses. This includes custom functions tied to UI events like opening modals, scrolling to the top of the page, and handling form submissions.",
      conditionalLogic: "Conditional Logic: Implementing conditions to control the flow of the application, such as displaying elements only when certain conditions are met (e.g., scroll position).",
      cssManipulation: "CSS Manipulation: Dynamically adjusting CSS properties through JavaScript to affect the layout and styling of elements based on user interactions or conditions.",
      arrayOperations: "Array Operations: Using array methods like forEach, filter, and map to manipulate data sets, particularly in functions that handle autocomplete features and project searching.",
      templateManipulation: "Template Manipulation: Using string literals and template manipulation to dynamically generate HTML content based on data.",
      modularFunctions: "Modular Functions: Creating reusable functions that encapsulate functionality for specific tasks, such as toggling an accordion or handling form submissions.",
      errorHandling: "Error Handling: Implementing basic error handling in asynchronous operations to manage exceptions and provide feedback.",
      debugging: "Debugging: Logging information to the console for debugging purposes, particularly in the search functionality to trace computations and results.",
      uriManipulation: "URI Manipulation: Manipulating the window's location hash for navigation purposes and using it to trigger specific actions like accordion expansion.",
  ...
  es: {
      ...
      cpp: "HTML, CSS, JavaScript",
      frontendContent: "Este sitio web de portafolio es un ejemplo de mi conjunto de habilidades con HTML, CSS y JavaScript; a continuación se muestran las habilidades que he utilizado para crear una interfaz de usuario interactiva y dinámica.",
      javascriptSkills: "Habilidades de JavaScript",
      asyncProgramming: "Programación Asíncrona: Se utiliza la API fetch para recuperar datos JSON de forma asíncrona, demostrando el manejo de promesas con .then() y .catch() para el manejo de errores.",
      domManipulation: "Manipulación del DOM: Manipulación del Modelo de Objeto de Documento (DOM) para cambiar dinámicamente el contenido, estilos y clases según las acciones del usuario o datos, como actualizar el contenido del texto, mostrar y ocultar elementos, y agregar o eliminar clases CSS.",
      eventHandling: "Manejo de Eventos: Configuración de oyentes de eventos para manejar interacciones del usuario, como clics, desplazamientos y pulsaciones de teclas. Esto incluye funciones personalizadas vinculadas a eventos de UI como abrir modales, desplazarse hasta la parte superior de la página y manejar envíos de formularios.",
      conditionalLogic: "Lógica Condicional: Implementación de condiciones para controlar el flujo de la aplicación, como mostrar elementos solo cuando se cumplen ciertas condiciones (por ejemplo, posición de desplazamiento).",
      cssManipulation: "Manipulación de CSS: Ajuste dinámico de propiedades CSS a través de JavaScript para afectar la disposición y el estilo de los elementos según las interacciones del usuario o condiciones.",
      arrayOperations: "Operaciones de Array: Uso de métodos de array como forEach, filter y map para manipular conjuntos de datos, particularmente en funciones que manejan características de autocompletado y búsqueda de proyectos.",
      templateManipulation: "Manipulación de Plantillas: Uso de literales de cadena y manipulación de plantillas para generar dinámicamente contenido HTML basado en datos.",
      modularFunctions: "Funciones Modulares: Creación de funciones reutilizables que encapsulan funcionalidad para tareas específicas, como alternar un acordeón o manejar envíos de formularios.",
      errorHandling: "Manejo de Errores: Implementación de manejo de errores básico en operaciones asíncronas para gestionar excepciones y proporcionar retroalimentación.",
      debugging: "Depuración: Registro de información en la consola para fines de depuración, particularmente en la funcionalidad de búsqueda para rastrear cálculos y resultados.",
      uriManipulation: "Manipulación de URI: Manipulación del hash de la ubicación de la ventana para fines de navegación y su uso para activar acciones específicas como la expansión del acordeón.",
  ...
  pt: {
      ...
      cpp: "HTML, CSS, JavaScript",
      frontendContent: "Este site de portfólio é o exemplo do meu conjunto de habilidades com HTML, CSS e JavaScript; abaixo estão as habilidades que usei para criar uma interface de usuário interativa e dinâmica.",
      javascriptSkills: "Habilidades de JavaScript",
      asyncProgramming: "Programação Assíncrona: A API fetch é usada para recuperar dados JSON de forma assíncrona, demonstrando o manuseio de promessas com .then() e .catch() para tratamento de erros.",
      domManipulation: "Manipulação do DOM: Manipulação do Modelo de Objeto de Documento (DOM) para alterar dinamicamente o conteúdo, estilos e classes com base nas ações do usuário ou dados, como atualizar o conteúdo do texto, mostrar e ocultar elementos e adicionar ou remover classes CSS.",
      eventHandling: "Manuseio de Eventos: Configuração de ouvintes de eventos para lidar com interações do usuário, como cliques, rolagens e pressionamentos de teclas. Isso inclui funções personalizadas vinculadas a eventos de UI, como abrir modais, rolar para o topo da página e lidar com envios de formulários.",
      conditionalLogic: "Lógica Condicional: Implementação de condições para controlar o fluxo da aplicação, como exibir elementos apenas quando determinadas condições são atendidas (por exemplo, posição de rolagem).",
      cssManipulation: "Manipulação de CSS: Ajuste dinâmico das propriedades CSS através do JavaScript para afetar o layout e o estilo dos elementos com base nas interações ou condições do usuário.",
      arrayOperations: "Operações de Array: Uso de métodos de array como forEach, filter e map para manipular conjuntos de dados, particularmente em funções que lidam com recursos de autocompletar e pesquisa de projetos.",
      templateManipulation: "Manipulação de Templates: Uso de literais de string e manipulação de templates para gerar dinamicamente conteúdo HTML com base em dados.",
      modularFunctions: "Funções Modulares: Criação de funções reutilizáveis que encapsulam a funcionalidade para tarefas específicas, como alternar um acordeão ou lidar com envios de formulários.",
      errorHandling: "Tratamento de Erros: Implementação de tratamento básico de erros em operações assíncronas para gerenciar exceções e fornecer feedback.",
      debugging: "Depuração: Registro de informações no console para fins de depuração, particularmente na funcionalidade de pesquisa para rastrear cálculos e resultados.",
      uriManipulation: "Manipulação de URI: Manipulação do hash da localização da janela para fins de navegação e seu uso para acionar ações específicas, como a expansão do acordeão.",
