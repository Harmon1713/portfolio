const translations = {
    en: {
      ...
      research: "Research",
      frontendModal: "Full Stack Development",
      cppApp: "Portfolio Website",
      cppAppfront: "Front End",
      cppAppback: "Back End",
      cpp1: "HTML (Bootstrap), CSS, JavaScript (jQuery, popper.js)",
      cpp2: "Node.js, Express (Render), Google Apps Scripts",
      ...
      backendContent: "Built and deployed RESTful APIs using Node.js and Express to handle dynamic routing, server-side logic, and database interactions. Integrated front-end interfaces with secure backend endpoints deployed on Render, enabling full-stack functionality and scalable hosting. Developed custom automation solutions using Google Apps Script to streamline workflows within Google Sheets, Forms, and Docs. Projects include automated email responses, form data processing, and live dashboard generation—demonstrating both scripting proficiency and API integration with Google Workspace tools.",
      ...
      skill_BackEndDevelopment: "Back-End Development",
      skill_FullStackDevelopment: "Full Stack Development",
      ...
      feedbackDescription: "What did you think of this site? I'd love to know.",
    ...
    es: {
      ...
      frontendModal: "Desarrollo Full Stack",
      ...
      backendContent: "Se crearon e implementaron API RESTful con Node.js y Express para gestionar el enrutamiento dinámico, la lógica del lado del servidor y las interacciones con la base de datos. Se integraron interfaces front-end con puntos finales back-end seguros implementados en Render, lo que permitió una funcionalidad integral y un alojamiento escalable. Se desarrollaron soluciones de automatización personalizadas con Google Apps Script para optimizar los flujos de trabajo en Hojas de Cálculo, Formularios y Documentos de Google. Los proyectos incluyen respuestas automatizadas por correo electrónico, procesamiento de datos de formularios y generación de paneles en vivo, lo que demuestra la competencia en scripting y la integración de API con las herramientas de Google Workspace.",
      ...
      skill_BackEndDevelopment: "Desarrollo Back-End",
      skill_FullStackDevelopment: "Desarrollo Full Stack",
      skill_Tableau: "Tableau",
      ...
      detailsText1: "Con una maestría en informática y licenciaturas en ingeniería y español, mi formación académica refleja una diversa intersección de disciplinas. Mi trayectoria profesional incluye roles como profesora, consultora en visualización de datos y técnica en ingeniería biomédica. Además, mi experiencia en varios continentes y dominio de varios idiomas me permite colaborar eficazmente a través de culturas y fronteras.",
      detailsText2: "Por favor, contáctame para que podamos hablar sobre cómo nuestras habilidades y experiencias pueden ayudarnos a alcanzar nuestras metas.",
      contactInfoTitle: "Información de Contacto",
      feedbackHeader: "Comentarios",
      feedbackDescription: "¿Qué opinas de este sitio? Me encantaría saberlo.",
      messageLabel: "Mensaje:",
      categoryLabel: "Categoría:",
      praiseOption: "Elogio",
      suggestionOption: "Sugerencia",
      bugOption: "Error",
      otherOption: "Otro",
      submitButton: "Enviar Comentarios",
      enterMessageError: "Por favor, ingresa un mensaje.",
      submissionError: "Algo salió mal. Inténtalo de nuevo.",
      thankYouMessage: "¡Gracias por tus comentarios!",
      submitMoreButton: "Enviar más comentarios",
      // Currículum
    ...
    pt: {
      ...
      frontend: "Desenvolvimento Full Stack",
      ...
      research: "Pesquisa",
      frontendModal: "Desenvolvimento Full Stack",
      ...
      backendContent: "Criação e implantação de APIs RESTful usando Node.js e Express para lidar com roteamento dinâmico, lógica do lado do servidor e interações com bancos de dados. Interfaces front-end integradas com endpoints back-end seguros implantados no Render, permitindo funcionalidade full-stack e hospedagem escalável. Desenvolvimento de soluções de automação personalizadas usando o Google Apps Script para otimizar fluxos de trabalho no Planilhas, Formulários e Documentos Google. Os projetos incluem respostas automatizadas por e-mail, processamento de dados de formulários e geração de painéis ao vivo, demonstrando proficiência em scripts e integração de APIs com as ferramentas do Google Workspace.",
      ...
      skill_BackEndDevelopment: "Desenvolvimento Back-End",
      skill_FullStackDevelopment: "Desenvolvimento Full Stack",
      skill_Tableau: "Tableau",
      ...
      detailsText1: "Com um mestrado em Informática e bacharelados em Engenharia e Espanhol, minha formação acadêmica reflete uma interseção diversificada de disciplinas. Minha trajetória profissional inclui cargos como professora, consultora de visualização de dados e técnica em engenharia biomédica. Além disso, minha experiência em vários continentes e proficiência em vários idiomas me permite colaborar eficazmente além de fronteiras e culturas.",
      detailsText2: "Entre em contato para que possamos conversar sobre como nossas habilidades e experiências podem nos ajudar a alcançar nossos objetivos.",
      contactInfoTitle: "Informações de Contato",
      feedbackHeader: "Feedback",
      feedbackDescription: "O que você achou deste site? Gostaria muito de saber.",
      messageLabel: "Mensagem:",
      categoryLabel: "Categoria:",
      praiseOption: "Elogio",
      suggestionOption: "Sugestão",
      bugOption: "Erro",
      otherOption: "Outro",
      submitButton: "Enviar Feedback",
      enterMessageError: "Por favor, digite uma mensagem.",
      submissionError: "Algo deu errado. Tente novamente.",
      thankYouMessage: "Obrigada pelo seu feedback!",
      submitMoreButton: "Enviar mais feedback",
      // Currículo
